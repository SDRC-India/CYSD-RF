		...
		<div class="content">
			<div class="container-fluid">
				...
				<div class="row text-center">
					...
					<h2 class="text404">Oops !!! Looks like you are caught in a wrong place ...</h2>
					<h4 class="text404">Please try again in sometime, while we are fixing this up.</h4>

					<p class="text404">${exception.message}</p>
